...
def stadio_riferimento(r):
    # Se l'ultimo mese è vuoto, usa l'ultimo stadio conosciuto nello storico.
    # Così un cliente dormiente su Preventivo resta classificato come Forte,
    # non come famiglia vuota.
    for col in [
        "Ultima attività",
...
regole_ra = pd.DataFrame([
    ...
    ["STADIO_RIFERIMENTO", "Se l’ultimo mese non ha attività, prende l’ultimo stadio conosciuto nello storico. Serve per capire se il cliente è dormiente su Telefonata, Richiesta, Preventivo o Delibera."],
