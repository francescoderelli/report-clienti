...
regole_ra = pd.DataFrame([
    ...
    ["FOGLIO AVANZAMENTO_CLIENTI", "Contiene una riga per ogni amministratore con il confronto tra attività nei diversi blocchi temporali e le valutazioni automatiche."],
    ...
    ["FOGLIO DA_ATTENZIONARE", "Contiene i casi da monitorare, ma non ancora da riassegnare automaticamente."],
    ["FOGLIO ANOMALIE", "Contiene i casi con andamenti incoerenti o sospetti da controllare manualmente."],
